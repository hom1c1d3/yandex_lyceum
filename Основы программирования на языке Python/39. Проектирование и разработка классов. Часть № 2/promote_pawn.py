...
class Board:
    ...
    def move_and_promote_pawn(self, row, col, row1, col1, char):
        ...
        if char == 'Q':
            self.field[row1][col1] = Queen(pawn.get_color())
        elif char == 'R':
            self.field[row1][col1] = Rook(pawn.get_color())
        elif char == 'B':
            self.field[row1][col1] = Bishop(pawn.get_color())
        elif char == 'N':
            self.field[row1][col1] = Knight(pawn.get_color())
        self.color = opponent(self.color)
        return True
...
def check():
    ...
    board.field[0][4] = Bishop(WHITE)

    board.field[6][4] = Pawn(WHITE)
    board.field[7][5] = Knight(WHITE)
    ...
    print(board.move_and_promote_pawn(6, 3, 7, 3, 'Q'))
    print(board.move_and_promote_pawn(1, 5, 0, 4, 'Q'))
    print(board.move_and_promote_pawn(6, 4, 7, 5, 'Q'))
