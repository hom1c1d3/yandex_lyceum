coord = {'x': int(input("координата по X: ")), 'y': int(input("координата по Y: "))}
...
while current_cord != coord:
    move_direction = input("направление: ").lower().replace("ё", "е")
    if move_direction == "вперед":
        num_moves = int(input("количество шагов: "))
...
print("\r\033[K\0", min_moves_num, current_direction, sep="\n")
