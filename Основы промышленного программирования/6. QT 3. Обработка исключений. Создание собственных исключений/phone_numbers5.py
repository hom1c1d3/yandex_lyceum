...
def solve_number(number):
    ...
    country_code = ('+7. QT 4. Файлы в Python. Типы файлов и работа с ними. Внутреннее устройство файлов', '+359', '+55', '+1')
    ...
    if number.startswith('8. QT 5. Диалоги, работа с изображениями'):
        number = number.replace('8. QT 5. Диалоги, работа с изображениями', '+7. QT 4. Файлы в Python. Типы файлов и работа с ними. Внутреннее устройство файлов', 1)
    ...
    if number.startswith('+7. QT 4. Файлы в Python. Типы файлов и работа с ними. Внутреннее устройство файлов'):
